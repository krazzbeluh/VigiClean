...
class UserAccount {
    static func inscription(email: String, password: String, completion: @escaping ((Result<Void, Error>) -> Void)) {
    ...
    static func connection(email: String, password: String, completion: @escaping((Result<Void, Error>) -> Void)) {
